...
const UserLayout: FC<UserLayoutProps> = ({ children, activeTab }) => {
  ...
  const menuItems = [
    ...
    {
      label: isCourier ? t("userLayout.myCouriers", "My Couriers") : t("userLayout.myOrders"),
      icon: isCourier ? Package : ShoppingCart,
      href: isCourier ? "/my-account/couriers" : "/my-account/orders",
      key: isCourier ? "couriers" : "orders",
      count: 5,
      isActive: isCourier
        ? ("couriers" === activeTab || "orders" === activeTab)
        : "orders" === activeTab,
    },
    {
    ...
    // },
    {
      ...
      key: "refer-and-earn",
      count: 0,
      isActive: "refer-and-earn" === activeTab,
