...
export interface Product {
  ...
  restaurant_is_product_available?: boolean;
  product_display_status?: string;
}
...
export type ReferralProgram = {
  status: boolean;
  referrer_bonus_method: "fixed" | "percentage" | string;
  referrer_bonus_value: string;
  referrer_bonus_max_cap: string;
  referee_bonus_method: "fixed" | "percentage" | string;
  referee_bonus_value: string;
  referee_bonus_max_cap: string;
  minimum_order_amount: string;
  max_times_bonus: string;
};
...
export interface Store {
  ...
  logo: string;
  banner: string;
  order_preparation_time?: string | null;
  domestic_shipping_charges?: string | number | null;
...
export interface CourierRequest {
  ...
  parcel_type: string | { id: number; name: string };
  parcel_type_data?: { id?: number; name: string };
  parcel_size?: string;
  ...
  distance_rate?: string | number;
  distance_charge?: string | number;
  per_kg_rate?: string | number;
  weight_charge?: string | number;
  surge_multiplier?: string | number;
  surge_charge?: string | number;
  rto_multiplier?: string | number | null;
  rto_charge?: string | number;
  total_rto_charge?: string | number;
  extra_rto_charge?: string | number;
  already_payable_amount?: string | number;
  remaining_pending_amount?: string | number;
  cancelled_by?: string;
