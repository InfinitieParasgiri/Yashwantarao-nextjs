...
export const getServerSideProps: GetServerSideProps | undefined = isSSR()
  ? async (context) => {
    try {
      const activeModule = getCookieFromContext<string>(context, "activeModule") || "grocery";
      const [zonesResult, settingsResult] = await Promise.allSettled([
        getDeliveryZones({ page: 1, per_page: PER_PAGE, business_type: activeModule }),
        getSettings(),
      ]);
