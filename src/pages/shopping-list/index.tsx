...
const fetchProductsByKeywords = async (keywordString: string, business_type?: string) => {
  if (!keywordString) {
...
const ShoppingListPageComponent: NextPageWithLayout = () => {
  ...
  const {
    ...
    ([, keywordsParam]) => fetchProductsByKeywords(keywordsParam as string, business_type),
    {
