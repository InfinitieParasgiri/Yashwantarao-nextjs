...
const MyAccount: NextPageWithLayout<MyAccountPageProps> = ({ initialData }) => {
  ...
  const onSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.name || formData.name.trim() === "") {
      addToast({
        title: t("error", "Error"),
        description: t("validation.required", "Name is required"),
        color: "danger",
      });
      return;
    }
    ...
    if (!formData.email || formData.email.trim() === "") {
      addToast({
        title: t("error", "Error"),
        description: t("validation.required", "Email is required"),
        color: "danger",
      });
      return;
    }
    ...
    if (!formData.mobile || formData.mobile.trim() === "") {
      const errorMsg = t("validation.mobileRequired", "Phone number is required");
      setFieldErrors((prev) => ({
        ...prev,
        phone: errorMsg,
      }));
