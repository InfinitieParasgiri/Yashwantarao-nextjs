...
const CheckoutForm: React.FC<{
  ...
  isLoading: boolean;
  usageType?: "order" | "wallet" | "courier";
  walletOrderData?: any;
  ...
  const handleSubmit = useCallback(
    async (e?: React.FormEvent) => {
      ...
      try {
        ...
        if (res.success) {
          onSuccess(usageType === "courier" ? { transaction_id: paymentIntent.id } : undefined);
          addToast({
            title:
              usageType === "wallet"
...
const Stripe: React.FC<StripeProps> = ({
  ...
  const amount =
    usageType === "wallet"
      ...
      : (customAmount || cartData?.payment_summary?.payable_amount);
