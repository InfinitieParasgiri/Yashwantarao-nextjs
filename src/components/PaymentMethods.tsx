...
const PaymentMethods: FC<PaymentMethodsProps> = ({
  ...
  const allMethods = [
    {
      ...
      isEnabled: !!paymentSettings?.cod && !hideCOD,
    },
    {
    ...
    },
    {
      ...
      isEnabled: !!paymentSettings?.stripePayment,
    },
    {
      ...
      isEnabled: !!paymentSettings?.flutterwavePayment,
    },
    {
      id: "paypal",
    ...
    },
    {
      ...
      isEnabled: !!paymentSettings?.razorpayPayment,
    },
    {
      id: "paystackPayment",
      ...
      isEnabled: !!paymentSettings?.paystackPayment,
    },
    {
      id: "phonepe",
  ...
  const paymentMethods = [...allMethods.filter((method) => method.isEnabled), ...extraMethods];
