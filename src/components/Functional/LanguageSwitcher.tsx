...
const LanguageSwitcher = ({ variant = "default" }: { variant?: "default" | "transparent" }) => {
  ...
  return (
    ...
    >
      <DropdownTrigger className="w-fit sm:w-4">
        <Button variant="light" className={clsx("flex items-center gap-2 p-0", variant === "transparent" ? "text-white" : "text-gray-600")}>
          <div className="flex gap-1 items-end">
            ...
            <ChevronDown className={clsx("w-4 h-4", variant === "transparent" ? "text-white" : "text-gray-600")} />
          </div>
        </Button>
      </DropdownTrigger>
      <DropdownMenu
