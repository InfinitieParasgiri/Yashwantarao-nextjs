    ...
    try {
      ...
      if (isFirebaseGateway) {
        ...
        response = await verifyOtp({
          mobile: otpPhoneNumber,
          otp,
          friends_code: (friendsCode as string) || undefined,
        });
      }
    ...
    <>
      ...
      {triggerView === "btn" ? (
        <MyButton
          id="login-btn"
          onPress={onOpen}
          variant={variant === "white" ? "solid" : "flat"}
          className={clsx(
            "p-0 text-sm h-8 px-2",
            variant === "white" ? "bg-white text-gray-800 rounded-md shadow-sm hover:shadow-md border-none" : "text-xs"
          )}
        >
          <div className="flex items-center gap-2">
            <LogIn size={18} className={variant === "white" ? "text-gray-600" : ""} />
            <span>{t("login_modal.button")}</span>
          </div>
        </MyButton>
      ) : triggerView === "icon" ? (
        <Button
              ...
              <ModalBody className="py-6">
                ...
                <div className="w-full flex justify-center mb-6">
                  ...
                  >
                    <Tab
                      key="mobile"
                      textValue={t("login_modal.mobile_tab")}
                      title={
                        <div className="flex items-center gap-2">
                          <Smartphone size={16} />
                    ...
                    <Tab
                      key="email"
                      textValue={t("login_modal.email_tab")}
                      title={
                        <div className="flex items-center gap-2">
                          <Mail size={16} />
                    ...
                    <Tab
                      key="otp"
                      textValue={t("login_modal.otp_tab")}
                      title={
                        <div className="flex items-center gap-2">
                          <Phone size={16} />
