          ...
          >
            {allImages.map((image, index) => (
              <SwiperSlide key={index}>
                <div
                  className={`h-[40vh] md:h-[60vh] w-full flex justify-center items-center ${fit === "contain" ? "bg-gray-100 dark:bg-gray-950" : "bg-transparent"} rounded-[24px] overflow-hidden`}
                >
                  <Image
                    src={image}
                    alt={`Main Image ${index + 1}`}
                    radius="none"
                    className={`w-full h-[40vh] md:h-[60vh] object-${fit}`}
            ...
            {hasVideo && (
              <SwiperSlide key="video">
                <div className="h-[40vh] md:h-[60vh] w-full flex justify-center items-center bg-black rounded-[24px] overflow-hidden">
