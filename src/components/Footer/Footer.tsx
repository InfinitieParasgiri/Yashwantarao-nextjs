...
const Footer: FC = () => {
  ...
  const getSellerLinks = () => {
    ...
    if (isLandingPage) {
      return [
        {
          label: t("footer.quick_links.become_grocery_seller", "Become Grocery Seller"),
          href: "/seller-register?module=grocery",
        },
        {
          label: t("footer.quick_links.become_restaurant_seller", "Become Restaurant Seller"),
          href: "/seller-register?module=restaurant",
        },
      ];
    }
    if (activeModule === "grocery") {
      return [
        {
          label: t("footer.quick_links.become_seller", "Become a Seller"),
          href: "/seller-register?module=grocery",
        },
      ];
    }
  ...
  // Show stores link only on landing page or in restaurant module (not grocery)
  const showStoresLink = isMounted && (isLandingPage || activeModule === "restaurant");

  const sellerLinks = getSellerLinks();
        ...
        <div className="block sm:hidden space-y-6">
          ...
          <div className="text-center space-y-3">
            <div className="w-full flex justify-center">
              <Link href={homeRoute} title={t("nav.home")}>
                <Image
                  src={siteFooterLogo}
                  alt={siteName}
                  radius="none"
            ...
            <div>
              ...
              <div className="space-y-1">
                {[
                  ...
                  ...(!isSingleVendor && showStoresLink
                    ? [
                      {
                        label: activeModule === "restaurant" ? t("footer.quick_links.restaurants", "Restaurants") : t("footer.quick_links.stores", "Stores"),
                        href: "/stores",
                      },
                    ]
                    : []),
                  ...(!isSingleVendor ? sellerLinks : []),
                ].map(({ label, href }) => (
                  <Link
                    key={label}
                    href={href}
