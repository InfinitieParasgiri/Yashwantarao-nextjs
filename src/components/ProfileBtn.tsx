...
import { FC, Key, ReactNode, useState, useEffect } from "react";
...
const ProfileBtn: FC = () => {
  ...
  const profileMenuItems: ProfileMenuItem[] = [
    ...
    ...(!isCourier
      ? [
        {
          key: "/my-account/wishlists",
          icon: <Bookmark size={16} />,
          text: t("userLayout.myWishlists", "My Wishlists"),
        },
      ]
      : []),
    {
      key: isCourier ? "/my-account/couriers" : "/my-account/orders",
      icon: <Package size={16} />,
      text: isCourier ? t("profileBtn.myCouriers", "My Couriers") : t("profileBtn.myOrders"),
    },
