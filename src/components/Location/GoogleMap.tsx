                  ...
                  pinElement.innerHTML = `
                    <div style="position: relative; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 21C16.4183 21 20 17.4183 20 13C20 8.58172 16.4183 5 12 5C7.58172 5 4 8.58172 4 13C4 17.4183 7.58172 21 12 21Z" fill="#EF4444" stroke="white" stroke-width="2"/>
                        <circle cx="12" cy="13" r="3" fill="white"/>
                        <path d="M12 21L12 23" stroke="#EF4444" stroke-width="2" stroke-linecap="round"/>
                      </svg>
                    </div>
                  `;
