        ...
        <div className="space-y-2 text-xs">
          ...
          {(() => {
            const txId =
              ...
              (order as any).transaction_ref ||
              order.payment_response?.transaction_id ||
              order.payment_response?.razorpay_payment_id ||
              order.payment_response?.id ||
              "";
            ...
            return (
              <div className="flex justify-between items-center pt-1">
                ...
                <span className="text-xs font-mono font-medium text-gray-800 dark:text-gray-200 select-all">
                  {String(txId).trim()}
                </span>
              </div>
            );
