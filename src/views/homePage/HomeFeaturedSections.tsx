...
interface FeaturedSectionItemProps {
...
const FeaturedSectionItem: FC<FeaturedSectionItemProps> = ({
  section,
  isLoading,
  rtl,
  screen,
  ...
  const backgroundStyle = isStyle2 ? getBackgroundStyle(section, screen) : {};
...
const HomeFeaturedSections: FC<HomeFeaturedSectionsProps> = ({
  ...
  const {
    ...
    isLoading,
    mutate,
  } = useSWR(["/featured-sections", effectiveModule], fetcher, {
